> 🗄️ **ARCHIVED 2026-06-12 — superseded by [`../STATUS.md`](../STATUS.md).** Nearly all items are resolved;
> the few still-open ones are carried in the unified tracker's "Live operational debt" section.
